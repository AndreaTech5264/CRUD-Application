...
//file che serve ad implementare tutte le funzioni definite nel controller
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDto getEmployeeById(Long employeeId) {
        ...
        Employee employee=employeeRepository.findById(employeeId)
                .orElseThrow(() ->
                        new ResourceNotFoundException("Employee non trovato in base all'id: "+ employeeId));
    ...
    public EmployeeDto updateEmployee(Long employeeId, EmployeeDto updatedEmployee) {
       Employee employee= employeeRepository.findById(employeeId).orElseThrow(
                () -> new ResourceNotFoundException("Employee non esiste " + employeeId));
